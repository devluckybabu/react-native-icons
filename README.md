...
[![Travis](https://img.shields.io/travis/oblador/react-native-icons.svg)](https://travis-ci.org/oblador/react-native-icons) [![npm](https://img.shields.io/npm/v/react-native-icons.svg)](https://npmjs.com/package/react-native-icons) [![npm](https://img.shields.io/npm/dm/react-native-icons.svg)](https://npmjs.com/package/react-native-icons)

Perfect for buttons, logos and nav/tab bars. Easy to extend, style and integrate into your project.

If you want to use `.svg` files natively – try [`react-native-image`](https://github.com/oblador/react-native-image).
...
[Browse all](https://oblador.github.io/react-native-icons/).
...
1. Run: `$ yarn add react-native-icons`
...
- Browse to `node_modules/react-native-icons/Fonts` and drag the folder `Fonts` (or just the ones you want) to your project in Xcode. **Make sure your app is checked under "Add to targets" and that "Create groups" is checked if you add the whole folder**. Not familiar with Xcode? Try [this article](https://medium.com/@vimniky/how-to-use-icons-in-your-react-native-project-8212ac6a8f06)
...
```gradle
apply from: "../../node_modules/react-native-icons/fonts.gradle"
```
...
- Browse to `node_modules/react-native-icons` and drag the folder `Fonts` to your project in Xcode. **Make sure your app is checked under "Add to targets" and that "Create folder references" is checked**.
...
```js
{
  ...
  include: path.resolve(__dirname, "node_modules/react-native-icons"),
},
```
...
import Icon from 'react-native-icons/dist/FontAwesome';

// Generate required css
import iconFont from 'react-native-icons/Fonts/FontAwesome.ttf';
...
```jsx
import Icon from 'react-native-icons/FontAwesome5';
...
```js
import { createIconSet } from 'react-native-icons';
...
```js
import { createIconSetFromFontello } from 'react-native-icons';
...
```js
import { createIconSetFromIcoMoon } from 'react-native-icons';
...
```jsx
import { createMultiStyleIconSet } from 'react-native-icons';
...
## [Changelog](https://github.com/oblador/react-native-icons/releases)
